...
# Model of standardised breeding success ---------------------------------------
	...
	# Model diagnostics (as per: https://rpubs.com/bbolker/glmmchapter)
		pdf("Figs/SOM_Fig3.pdf", width = 8, height = 6)
		grid.arrange(plot(f.sbs.fin, type = c("p", "smooth"), col = "black"),
								 ...
								 qqnorm(f.sbs.fin, abline = c(0, 1), col = "black")
								 ) # Looks pretty good!
		dev.off()
...
# Goto 3_Hemispheric_Assymmetry.R
